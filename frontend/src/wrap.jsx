...
function Header() {
	return (
		<header className="sticky top-0 z-10 bg-blend-darken flex justify-start max-h-20 items-center text-slate-50 border-b-2 border-slate-700 bg-[#111924] p-4">
			...
			<ul className="list-none w-full flex justify-around items-center font-serif text-xl">
				<li className="hover:text-yellow-400 transform transition duration-100 hover:-translate-y-0.5">
					<a href="/">Home</a>
				</li>
				<li className="hover:text-yellow-400 transform transition duration-100 hover:-translate-y-0.5">
